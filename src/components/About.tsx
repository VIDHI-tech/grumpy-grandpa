  ...
  return (
    <>
      ...
      >
        ...
        <h1 className="text-lg pt-10 pb-5 lg:pt-0 lg:pb-3 2xl:pb-7 md:text-2xl xl:text-4xl text-[#FF1D0F] comical font-bold" style={{textShadow: "7px 7px 3px rgba(0, 0, 0, 0.7)"}}>About the coin</h1>
